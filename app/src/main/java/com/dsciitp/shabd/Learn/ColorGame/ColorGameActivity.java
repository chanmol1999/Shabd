...
public class ColorGameActivity extends AppCompatActivity implements ColorAdapter.OnCategorySelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int span = preferences.getInt("span", 2);
        ...
        int d = preferences.getInt("correctanswer", 0);
    ...
    public void createQuestion() {
        ...
        ColorAdapter colorAdapter = new ColorAdapter(colours, this, (ColorAdapter.OnCategorySelectedListener) this);
